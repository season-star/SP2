...
class Processor(object):
    ...
    def train(self):
        ...
        def show_var(text_var, slot_var, intent_var, kb_var):
            print("  ~~~~~~~~~~~~~~~~~~   ")
            print(text_var)
            print("  ~~~~~~~~~~~~~~~~~~   ")
            print(slot_var)
            ...
            print("  ~~~~~~~~~~~~~~~~~~   ")
            print(kb_var)
            print("%s %s %s" % (len(text_var), len(slot_var), len(intent_var)))
        ...
        for epoch in range(0, self.__dataset.num_epoch):
            ...
            for text_batch, slot_batch, intent_batch, kb_batch, text_triple_batch, dial_id_batch, turn_id_batch, history_batch in tqdm(dataloader, ncols=50):
                ...
                # 随机生成的random。slot&intent forcing rate都是0.9
    ...
    def prediction(model, dataset, mode, batch_size):
        ...
        for text_batch, slot_batch, intent_batch, kb_batch, text_triple_batch, dial_id_batch, turn_id_batch, history_batch in tqdm(dataloader, ncols=50):
            ...
            #     print(text_batch[i])
            #     print(slot_batch[i])
            #     print(intent_batch[i])
            #     print(text_triple_batch[i])
            #     print(kb_batch[i])
            #     print("------------------")
